...
AmCharts.wrappedText = function (a, b, c, d, e, f, g, h, k) {
  ...
  if (l) {
    ...
    if (n.width > h) {
      l.remove();
      for (var l = [
      ], p = 0; - 1 < (index = b.indexOf(' ', p)); ) l.push(index),
      p = index + 1;
      for (var q = Math.round(b.length / 2), r = 1000, s, p = 0; p < l.length; p++) {
...
AmCharts.AxisBase = AmCharts.Class({
  ...
  draw: function () {
    ...
    1) || 0 >= this.minimum)) this.fire('logarithmicAxisFailed', {
      ...
      if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || - Infinity == this.max) g = !0;
        ...
        for (d = p; d < q; d += n) if (p = s * d + this.min, h && this.max - this.min > 5 * this.min && (p -= this.min), p = AmCharts.roundTo(p, this.maxDecCount + 1), !this.integersOnly || Math.round(p) == p) if (isNaN(w) || Number(AmCharts.toFixed(p, w)) == p) {
          ...
          if (p == this.baseValue && 'radar' != a.type) {
            ...
            v = this.viX;
            u = this.viY;
            'H' == this.orientation ? 0 <= c && c <= x + 1 && (F = [
              c,
              c,
              c + e
            ], G = [
      ...
      e = this.labelsSet;
      this.positionTitle();
      'radar' != a.type ? (a = this.viX, f = this.viY, b.translate(a, f), e.translate(a, f))  : h.toFront();
  ...
  getCoordinate: function (a) {
    ...
    10000000 < Math.abs(b) && (b = 10000000 * (b / Math.abs(b)));
    return Math.round(b)
  },
  ...
  construct: function (a) {
    ...
    n = a.viW,
    p = b.container;
    'H' == a.orientation ? (d = AmCharts.line(p, [
      0,
      n
    ], [
      0,
      0
    ], d, e, c), this.axisWidth = a.width, 'bottom' == a.position ? (a = c / 2 + f + m + l - 1, c = k)  : (a = - c / 2 - f + l + h, c = g + k))  : (this.axisWidth = a.height, 'right' == a.position ? (d = AmCharts.line(p, [
      0,
      0,
      - g
    ], [
      ...
      m,
      m - h
    ], d, e, c), a = l + h, c = c / 2 + f + g + n + k - 1)  : (d = AmCharts.line(p, [
      0,
      0
    ], [
      0,
  ...
  construct: function (a, b, c, d, e, f, g, h, k, l, m) {
    ...
    if ('H' == Sa) {
      if (0 <= b && b <= Y + 1 && (0 < u && 0 < t && b + k <= Y + 1 && (oa = AmCharts.line(r, [
        b + k,
        b + k
      ], [
        0,
        u
      ], v, t, E), s.push(oa)), 0 < x && (W = AmCharts.line(r, [
        b,
        b + da,
        b + da
      ], [
      ...
      0 <= b && b <= L + 1 && (0 < u && 0 < t && b + k <= L + 1 && (oa = AmCharts.line(r, [
        0,
        u
      ], [
        b + k,
      ...
      D = b - p / 2;
      1 == V && 0 < F && !g && !l && (d = AmCharts.fitToBounds(b, 0, L), ta = AmCharts.fitToBounds(ta, 0, L), Z = d - ta, fill = AmCharts.polygon(r, [
        0,
        a.width,
        a.width,
        0
        ...
        Z,
        Z
      ], H, F), fill.translate(da, d - Z + ba), s.push(fill));
      D += p / 2;
  ...
  drawBackground: function () {
    ...
    this.realHeight = f;
    this.background = b = AmCharts.polygon(a, [
      0,
      e - 1,
      e - 1,
      0
  ...
  updateAnimations: function () {
    ...
    for (a = this.animations.length - 1; 0 <= a; a--) {
      ...
      c = 1000 * b.time / AmCharts.updateRate,
      d = b.frame + 1,
      e = b.obj,
      f = b.attribute;
      if (d <= c) {
...
AmCharts.AmGraph = AmCharts.Class({
  ...
  createSerialGraph: function () {
    ...
    for (J = ia; J <= da; J++) {
      ...
      switch (g) {
        case 'line':
          if (isNaN(U)) w || (this.drawLineGraph(v, t, O, P), v = [
          ], t = [
          ], O = [
          ], P = [
          ]);
            ...
            this.dashLengthSwitched = y.dashLength;
            y.gap && (this.drawLineGraph(v, t, O, P), v = [
            ], t = [
            ], O = [
            ], P = [
            ])
          ...
          break;
        case 'smoothedLine':
          if (isNaN(U)) w || (this.drawSmoothedGraph(v, t, O, P), v = [
          ], t = [
          ], O = [
          ], P = [
          ]);
            ...
            ga = B;
            !Ea || isNaN(K) || isNaN(M) || (O.push(M), P.push(K));
            void 0 == y.lineColor && void 0 == y.fillColors && isNaN(y.dashLength) || (this.drawSmoothedGraph(v, t, O, P), v = [
              C
            ], t = [
              B
            ], O = [
            ], P = [
            ], !Ea || isNaN(K) || isNaN(M) || (O.push(M), P.push(K)), this.lineColorSwitched = y.lineColor, this.fillColorsSwitched = y.fillColors, this.dashLengthSwitched = y.dashLength);
            y.gap && (this.drawSmoothedGraph(v, t, O, P), v = [
            ], t = [
            ], O = [
            ], P = [
            ])
        ...
        case 'step':
          if (!isNaN(U)) {
            if (void 0 == y.lineColor && void 0 == y.fillColors && isNaN(y.dashLength) || (this.drawLineGraph(v, t, O, P), v = [
            ], t = [
            ], O = [
            ], P = [
            ], this.lineColorSwitched = y.lineColor, this.fillColorsSwitched = y.fillColors, this.dashLengthSwitched = y.dashLength), q ? (isNaN(u) || (v.push(u), t.push(B - ma)), t.push(B - ma), v.push(C), t.push(B + za), v.push(C), !Ea || isNaN(K) || isNaN(M) || (O.push(E), P.push(K - ma), O.push(M), P.push(K - ma), O.push(M), P.push(K + za)))  : (isNaN(x) || (t.push(x), v.push(u), t.push(x), v.push(C - ma)), v.push(C - ma), t.push(B), v.push(C + za), t.push(B), !Ea || isNaN(K) || isNaN(M) || (O.push(M - ma), P.push(A), O.push(M - ma), P.push(K), O.push(M + za), P.push(K))), u = C, x = B, E = M, A = K, ca = C, ja = B, fa = C, ga = B, Wa && (this.drawLineGraph(v, t, O, P), v = [
            ], t = [
            ], O = [
            ], P = [
            ], l && (Fa ? (this.lineColorSwitched = oa, this.fillColorsSwitched = pb)  : (this.lineColorSwitched = wa, this.fillColorsSwitched = Da))), Ib || y.gap) u = x = NaN,
        ...
        case 'column':
          ...
          if (!isNaN(U)) {
            ...
            if (ra && (sa = ra.set, y.columnGraphics = sa, sa.translate(X, Q), this.columnsSet.push(sa), (y.url || this.showHandOnHover) && sa.setAttr('cursor', 'pointer'), !ba)) {
              ...
              '3d' == V && (q ? (H = (this.end + 1 - J) * z - c - 1000 * this.depthCount, ca += F * this.columnIndex, fa += F * this.columnIndex, y.y += F * this.columnIndex)  : (H = (z - c) * (J + 1) + 1000 * this.depthCount, ca += 3, ja += G * this.columnIndex + 7, ga += G * this.columnIndex, y.y += G * this.columnIndex));
          ...
          if (!isNaN(ka) && !isNaN(U)) {
            ...
            if (q) {
              if (Q = B - h / 2, X = M, R = h, Q + R > n && (R = n - Q), 0 > Q && (R += Q, Q = 0), Q < n && 0 < R) {
                ...
                !isNaN(Ia) && !isNaN(Ha) && B < n && 0 < B && (jb = AmCharts.line(e, wb, [
                  B,
                  B
                ], qa, $, Y), vb = AmCharts.line(e, xb, [
                  B,
                  B
                ], qa, $, Y));
                ea = C - M;
              ...
              !isNaN(ya) && !isNaN(xa) && C < m && 0 < C && (jb = AmCharts.line(e, [
                C,
                C
              ], yb, qa, $, Y), vb = AmCharts.line(e, [
                C,
                C
              ], zb, qa, $, Y))
            }
...
g.animate.call(g)
}, c / (g.end - g.start + 1) * (b - g.start) * 1000), g.timeOuts.push(a))  : g.animate(a))
},
...
a = a.startEffect;
b && (this.rotate ? (b.translate( - 1000, e), c.translate( - 1000, e))  : (b.translate(d, - 1000), c.translate(d, - 1000)), b.animate({
opacity: 1,
translate: d +
',' + e
}, f, a), c.animate({
...
p && (n && n.remove(), 'function' == typeof p ? (n = new p, n.chart = this.chart, a.bulletConfig && (n.availableSpace = c, n.graph = this, n.graphDataItem = a, n.bulletY = c, a.bulletConfig.minCoord = this.minCoord -
...
e = c.mouseX - this.x,
f = c.mouseY - this.y;
this.drawingNow && (AmCharts.remove(this.drawingLine), this.drawingLine = AmCharts.line(this.container, [
this.x + this.drawStartX,
this.x + e
], [
this.y + this.drawStartY,
this.y +
f
...
if (c.mouseIsOver || E || A || this.forceShow) if (this.forceShow = !1, A) {
  ...
  if (a != this.previousIndex || H != this.previousMostCloseGraph) if (this.normalizeBulletSize(), this.destroyValueBalloons(), this.resizedBullets = [
  ], z && this.valueBalloonsEnabled && w && c.balloon.enabled) {
...
n = this.width,
p = this.height;
c ? (e && (a.pointerWidth = 0), 'right' == d ? e ? a.setBounds(l, m + h, l + n + k, m + p + h)  : a.setBounds(l + n + k + f, m + h, l + n + 1000, m + p + h)  : e ? a.setBounds(l, m, n + l, p + m)  : a.setBounds( - 1000, - 1000, l - g - f, m + p + 15))  : (a.maxWidth = n, b.parseDates && (g = 0, a.pointerWidth = 0), 'top' == d ? e ? a.setBounds(l + k, m + h, n + k + l, p + m)  : a.setBounds(l + k, - 1000, n + k + l, m + h - g - f)  : e ? a.setBounds(l, m, n + l, p + m - g)  : a.setBounds(l, m + p + g + f - 1, l + n, m + p + g + f))
},
...
G = this.bulletSize,
V;
0 < t || 0 === w ? (0 < s && (a = AmCharts.rect(e, z, u, n, 0, r + 1, F, s, this.cornerRadius), AmCharts.isModern ? a.translate(1, 1)  : a.translate(4, 4), f.push(a)), n = AmCharts.rect(e, z, u, n, this.fillAlpha, r, p, this.borderAlpha, this.cornerRadius), this.showBullet && (V = AmCharts.circle(e, G, q, this.fillAlpha), f.push(V)))  : (q = [
], t = [
], 'H' != v ? (g = a - A, g > z - w && (g = z - w), g < w && (g = w), q = [
  0,
  g - w,
  a - A,
  g + w,
  ...
  0,
  z
]), 0 < s && (a = AmCharts.polygon(e, q, t, n, 0, r, F, s), a.translate(1, 1), f.push(a)), n = AmCharts.polygon(e, q, t, n, this.fillAlpha, r, p, this.borderAlpha));
this.bg = n;
f.push(n);
n.toFront();
e = 1 * this.deltaSignX;
...
if (c.label) {
var d = c.ty,
d = AmCharts.line(this.container, [
  c.tx0,
  c.tx,
  c.tx2
], [
...
g = AmCharts.polygon(this.container, [
0,
e,
e,
0,
...
f,
0
], g, h, 1, k, l, this.plotAreaGradientAngle);
g.translate(c + a, d + b);
this.set.push(g);
0 !== a && 0 !== b && (g = this.plotAreaFillColors, 'object' == typeof g && (g = g[0]), g = AmCharts.adjustLuminosity(g, - 0.15), e = AmCharts.polygon(this.container, [
0,
a,
e + a,
e,
...
0,
0
], g, h, 1, k, l), e.translate(c, d + f), this.set.push(e), a = AmCharts.polygon(this.container, [
0,
0,
a,
a,
...
b,
0
], g, h, 1, k, l), a.translate(c, d), this.set.push(a));
...
isNaN(d) || isNaN(e) || isNaN(f) || isNaN(f) || (b.rotate ? (h = [
f,
g
], e = [
d,
...
f,
g
]), f = a.lineColor, d = AmCharts.line(c, h, e, f, a.lineAlpha, a.lineThickness, a.dashLength), g = h, k = e, n = h[1] - h[0], p = e[1] - e[0], 0 === n && (n = 0.01), 0 === p && (p = 0.01), l = n / Math.abs(n), m = p / Math.abs(p), p = n * p / Math.abs(n * p) * Math.sqrt(Math.pow(n, 2) + Math.pow(p, 2)), n = Math.asin(n / p), p = 90 * Math.PI / 180 - n, n = Math.abs(5 * Math.cos(p)), p = Math.abs(5 * Math.sin(p)), g.push(h[1] - l * p, h[0] - l * p), k.push(e[1] + m * n, e[0] + m * n), h = AmCharts.polygon(c, g, k, f, 0.005, 0), c = c.set([h,
d]), c.translate(b.marginLeftReal, b.marginTopReal), b.trendLinesSet.push(c), a.line = d, a.set = c, h.mouseup(function () {
a.handleLineClick()
}).mouseover(function () {
a.handleLineOver()
}).mouseout(function () {
...
h && a.gradient('radialGradient', [
c,
AmCharts.adjustLuminosity(c, - 0.6)
]);
return a
};
...
], f = 1; f < a.length; f++) for (var g = Number(a[f - 1]), h = Number(b[f - 1]), k = Number(a[f]), l = Number(b[f]), m = Math.sqrt(Math.pow(k - g, 2) + Math.pow(l - h, 2)), m = Math.round(m / 50) + 1, k = (k - g) / m, l = (l - h) / m, n = 0; n <= m; n++) {
...
var n = a.set();
for (m = 1; m < b.length; m++) for (var p = [
b[m - 1],
b[m]
], q = [
c[m - 1],
c[m]
], q = AmCharts.makeHD(p, q, a.handDrawScatter), p = q[0], q = q[1], r = 1; r < p.length; r++) n.push(AmCharts.line(a, [
p[r - 1],
p[r]
], [
q[r - 1],
q[r]
], d, e, f + Math.random() * a.handDrawThickness - a.handDrawThickness / 2, g, h, k, l, !0));
return n
};
...
a.handDrawn && (b = AmCharts.line(a, [
s,
t
], [
v,
u
], l.stroke, l.thickness * Math.random() * a.handDrawThickness, l['stroke-opacity']), d.push(b));
...
var c = b[a],
d = 1000 * c.time / AmCharts.updateRate,
e = c.frame + 1,
f = c.obj,
g = c.attribute,
h,
...
c = AmCharts.polygon(this.container, [
0,
h,
h,
0
...
l / 2,
l / 2
], d, a.lineAlpha, a.lineThickness, a.dashLength),
g.push(n),
...
(f = this.switchType) && 'none' != f && ('x' == f ? (q = this.createX(), q.translate(l / 2, l / 2))  : q = this.createV(), q.dItem = a, !0 !== a.hidden ? 'x' == f ? q.hide()  : q.show()  : 'x' != f && q.hide(), this.switchable || q.hide(), this.addListeners(q, a), a.legendSwitch = q, k.push(q));
f = this.color;
